...
public class VidAdapterBiology extends RecyclerView.Adapter<VidAdapterBiology.VideoViewHolder> {

    private Context context;
    private List<FileModelsBiology> videoList;

    public VidAdapterBiology(Context context, List<FileModelsBiology> videoList) {
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        FileModelsBiology video = videoList.get(position);

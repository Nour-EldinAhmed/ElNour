...
public class BiologyVideosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_floatbio).setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), BioUpload.class);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BiologyVideosActivity.this, "Failed to load videos", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        videoAdapter.setOnItemClickListener(video -> {
            ...
            Intent intent = new Intent(BiologyVideosActivity.this, VideoPlayerActivity.class);

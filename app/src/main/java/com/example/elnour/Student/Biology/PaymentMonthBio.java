...
public class PaymentMonthBio extends AppCompatActivity {
    ...
    private void verifyPaymentCode() {
        ...
        if (enteredCode.isEmpty()) {
            Toast.makeText(PaymentMonthBio.this, "Please enter the verification code.", Toast.LENGTH_SHORT).show();
            return;
        }
                                ...
                                if (document.contains("code") && document.getString("code").equals(enteredCode)) {
                                    ...
                                    db.collection("videos").document(enteredCode)
                                            ...
                                            .addOnSuccessListener(aVoid -> {
                                                Intent intent = new Intent(PaymentMonthBio.this, PurchasedVideosActivityBio.class);
                                            ...
                                            .addOnFailureListener(e -> {
                                                Toast.makeText(PaymentMonthBio.this, "Failed to store video details.", Toast.LENGTH_SHORT).show();
                                            });
                                } else {
                                    Toast.makeText(PaymentMonthBio.this, "Invalid verification code.", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(PaymentMonthBio.this, "Verification code does not exist.", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(PaymentMonthBio.this, "Failed to verify code.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

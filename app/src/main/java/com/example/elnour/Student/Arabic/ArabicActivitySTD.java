...
import com.example.elnour.Student.Arabic.PaymentMonthAra;
...
public class ArabicActivitySTD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arabic_std);
        db = FirebaseFirestore.getInstance();
        recyclerView = findViewById(R.id.rec_videoara);
        subscribeButton = findViewById(R.id.btn_monthly_subscriptionbara);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        videoList = new ArrayList<>();
        videoAdapter = new VideoAdapter(videoList, this);
        recyclerView.setAdapter(videoAdapter);

        databaseReference = FirebaseDatabase.getInstance().getReference("videos/Arabic");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ArabicActivitySTD.this, "Failed to load videos", Toast.LENGTH_SHORT).show();
            }
        });
/*
...
*/
        videoAdapter.setOnItemClickListener(video -> {
            ...
            db.collection("paymentCodes").whereArrayContains("videos", videoUrl).get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                Intent intent = new Intent(ArabicActivitySTD.this, VideoPlayerActivity.class);
                                intent.putExtra("videoUrl", videoUrl);
                                startActivity(intent);
                            } else {
                                Intent intent = new Intent(ArabicActivitySTD.this, PaymentMonth.class);
                                intent.putExtra("videoUrl", videoUrl);
        ...
        subscribeButton.setOnClickListener(v -> {
            ...
            if (selectedVideos.size() == MAX_SELECTION) {
                ...
                Intent intent = new Intent(ArabicActivitySTD.this, PaymentMonthAra.class);
                ...
                Toast.makeText(ArabicActivitySTD.this, "يجب اختيار 8 فيديوهات فقط", Toast.LENGTH_SHORT).show();
            }
        });
    }
}

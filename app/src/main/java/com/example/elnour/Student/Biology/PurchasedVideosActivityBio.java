...
public class PurchasedVideosActivityBio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoAdapter.setOnItemClickListener(video -> {
            Intent intent = new Intent(PurchasedVideosActivityBio.this, VideoPlayerActivity.class);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            ...
                            if (videoList.isEmpty()) {
                                Toast.makeText(PurchasedVideosActivityBio.this, "لا توجد فيديوهات مطابقة", Toast.LENGTH_SHORT).show();
                            }
                            videoAdapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(PurchasedVideosActivityBio.this, "لا توجد وثيقة بهذا الكود", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(PurchasedVideosActivityBio.this, "فشل في تحميل الفيديوهات", Toast.LENGTH_SHORT).show();
                    }
                });
    }

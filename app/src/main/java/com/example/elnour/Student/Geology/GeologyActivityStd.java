...
public class GeologyActivityStd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geology_std);
        db = FirebaseFirestore.getInstance();
        recyclerView = findViewById(R.id.rec_videogeo);
        subscribeButton = findViewById(R.id.btn_monthly_subscription);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(GeologyActivityStd.this, "Failed to load videos", Toast.LENGTH_SHORT).show();
            }
        });
/*
...
*/
        ...
        subscribeButton.setOnClickListener(v -> {
            ...
            if (selectedVideos.size() == MAX_SELECTION) {
                ...
                Intent intent = new Intent(GeologyActivityStd.this, PaymentMonth.class);
                ...
                Toast.makeText(GeologyActivityStd.this, "يجب اختيار 8 فيديوهات فقط", Toast.LENGTH_SHORT).show();
            }
        });
    }
}

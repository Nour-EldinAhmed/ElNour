...
public class PaymentMonth extends AppCompatActivity {
    ...
    private void verifyPaymentCode() {
        ...
        if (enteredCode.isEmpty()) {
            Toast.makeText(PaymentMonth.this, "Please enter the verification code.", Toast.LENGTH_SHORT).show();
            return;
        }
                                ...
                                if (document.contains("code") && document.getString("code").equals(enteredCode)) {
                                    ...
                                    db.collection("videos").document(enteredCode)
                                            ...
                                            .addOnSuccessListener(aVoid -> {
                                                Intent intent = new Intent(PaymentMonth.this, PurchasedVideosActivity.class);
                                            ...
                                            .addOnFailureListener(e -> {
                                                Toast.makeText(PaymentMonth.this, "Failed to store video details.", Toast.LENGTH_SHORT).show();
                                            });
                                } else {
                                    Toast.makeText(PaymentMonth.this, "Invalid verification code.", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(PaymentMonth.this, "Verification code does not exist.", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(PaymentMonth.this, "Failed to verify code.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

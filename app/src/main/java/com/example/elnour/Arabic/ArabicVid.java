...
public class ArabicVid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("videos/Arabic");
        ...
        if (videoUri != null) {
            ...
            videoRef.putFile(videoUri)
                    ...
                    .addOnSuccessListener(taskSnapshot -> videoRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(ArabicVid.this, "تم رفع الفيديو", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), ArabicVideosActivity.class);
                        startActivity(intent);
                    }))
                    .addOnFailureListener(e -> {
                        progressLayout.setVisibility(View.GONE);
                        showFailureNotification();
                        Toast.makeText(ArabicVid.this, "فشل رفع الفيديو", Toast.LENGTH_SHORT).show();
                    });
        } else {
    ...
    private void showSuccessNotification() {
        Intent intent = new Intent(this, ArabicVid.class);

...
public class VidAdapterGeology extends RecyclerView.Adapter<VidAdapterGeology.VideoViewHolder> {

    private Context context;
    private List<FileModelsGeology> videoList;

    public VidAdapterGeology(Context context, List<FileModelsGeology> videoList) {
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        FileModelsGeology video = videoList.get(position);

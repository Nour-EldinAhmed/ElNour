...
public class GeoUpload extends AppCompatActivity {
        ...
        if (videoUri != null) {
            ...
            videoRef.putFile(videoUri)
                    ...
                    .addOnSuccessListener(taskSnapshot -> videoRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(GeoUpload.this, "تم رفع الفيديو", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), GeologyVideosActivity.class);
                        startActivity(intent);
                    }))
                    .addOnFailureListener(e -> {
                        progressLayout.setVisibility(View.GONE);
                        showFailureNotification();
                        Toast.makeText(GeoUpload.this, "فشل رفع الفيديو", Toast.LENGTH_SHORT).show();
                    });
        } else {
    ...
    private void showSuccessNotification() {
        Intent intent = new Intent(this, GeologyVideosActivity.class);
